...
Esta política de Termos de Uso é válida a partir de Aug 2023.
TERMOS DE USO — Help Car
Help Car, pessoa jurídica de direito privado descreve, através deste documento, as regras de uso do site https://www.helpcar.com.br e qualquer outro site, loja ou aplicativo operado pelo proprietário.
...
A utilização deste website acarreta a adesão aos presentes Termos de Uso e a versão mais atualizada da Política de Privacidade de Help Car.

Seção 3 - Condições de acesso
Em geral, o acesso ao website da Help Car possui caráter gratuito e não exige prévia inscrição ou registro.
...
Partes deste website oferecem ao usuário a opção de publicar comentários em determinadas áreas. Help Car não consente com a publicação de conteúdos que tenham natureza discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de autor ou quaisquer outros direitos de terceiros.

A publicação de quaisquer conteúdos pelo usuário deste website, incluindo mensagens e comentários, implica em licença não-exclusiva, irrevogável e irretratável, para sua utilização, reprodução e publicação pela Help Car no seu website, plataformas e aplicações de internet, ou ainda em outras plataformas, sem qualquer restrição ou limitação.
...
Todos os elementos de Help Car são de propriedade intelectual da mesma ou de seus licenciados. Estes Termos ou a utilização do website não concede a você qualquer licença ou direito de uso dos direitos de propriedade intelectual da Help Car ou de terceiros.
...
O website no todo ou em cada uma das suas seções, pode ser encerrado, suspenso ou interrompido unilateralmente por Help Car, a qualquer momento e sem necessidade de prévio aviso.

Seção 8 - Dados pessoais
Durante a utilização deste website, certos dados pessoais serão coletados e tratados por Help Car e/ou pelos Parceiros. As regras relacionadas ao tratamento de dados pessoais de Help Car estão estipuladas na Política de Privacidade.

Seção 9 - Contato
Caso você tenha qualquer dúvida sobre os Termos de Uso, por favor, entre em contato pelo e-mail contato@helpcar.com.br.
  `;
